...
function activate(tab) {
  ...
  $('crumb').textContent = {chat:'Chat', contexts: 'Contexts', generator: 'Generator', test: 'Retrieval check'}[tab];
}
...
async function loadContexts() {
  ...
  data.items.forEach(item => {
    ...
    group.append(edit, toggle); actions.append(group); row.append(nameCell,tags,status,actions); $('context-rows').append(row);
  });
